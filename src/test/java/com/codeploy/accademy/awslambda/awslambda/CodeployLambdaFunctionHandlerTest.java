...
public class CodeployLambdaFunctionHandlerTest {
    ...
    @Test
    public void testCodeployLambdaFunctionHandler() {
        CodeployLambdaFunctionHandler handler = new CodeployLambdaFunctionHandler(s3Client);
